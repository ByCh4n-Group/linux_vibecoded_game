...
\section{bölüm 1 yıkılmış harabeler}

Derviş chara agartaha düşünce onu mümin çiçek selamlar.
Chara sarı çiçeğe sorar "annen baban var mıdır?" çiçekte cevap verirki "annem babam topraktır". Çiçek charaya tutoriel olarak tebliğ etmeyi ve tekfir
etmeyi gösterir. Sonrasında Anne keçi gelir Derviş çaraya harabeleri gösterir. Harabelerin arasında Chara bir kurbağa ailesi bulur, kurbağa ailesi Kurban 
bayramı için kurbanlık keçilerinin kaçtığını Charaya bildirir. Derviş çara ilerideki kapıdan geçmek ister, ama anne keçi onu durdurur. Ona kapının ardında
bir sürü kafir ve müşriğin var olduğunu söyler. Chara islamı kapının ardınada yaymak ister ama anne keçi buna engel olur. Chara da anne keçiyi tekfir edip
kurbanlık adak olarak kurbağa ailesi için kesip etini fakire fukaraya dağıtabilir, yada anne keçiyi tebliğ edebilir.

\section{bölüm 2 Hyperborea}

Derviş Chara kapının ardında iki tane iskeletle karşılaşır. bu iskeletler sans ve papyrus diamond tema izleyerek ve instagram reels takip ederek
ateist olmuşlardır. Chara papyrusu tekfir edebilir yada tebliğ edebiliyorsun. Derviş Chara Baldi hocayla karşılaşır. Baldi hoca ona elif-ba sorar.
Chara elifbayı bilemeyince baldi hoca Charayı dövmeye kalkar. Chara baldiden kaçarken Baldi Sansı küfrederken yakalar ve onu bir güzel döver.

\section{bölüm 3 şellalle ve ötesi}

SPC 106 kapkaççılık yapıyor, onu kovalamamız gerekiyor. kovalayıp kapkaççıyı dövüyoruz ve çantasından uyum elementi. Diğer uyum elementlerini ise bu
diyarda arayıp buluyoruz.

\section{bölüm 4 Ponyville}

Terry Davisin CIA ajanlarıyla dövüşüyoruz.

\section{bölüm 5 kralla dövüş}

Firavun Celestia ile fight.

\section{tekfir son}

Chara herkesi tekfir ettikten sonra tekfir edicek kimsesi kalmamıştır. En sonunda kendi kendini tekfir eder ve helak olur.
